...
<i>Trigger: User opens Smart Lang app offline, and clicks continue in offline mode</i>
...
<i> Trigger: User clicks on a vocab word to add to the speech box from the board </i> 
...
<i> Trigger: User clicks on a suggested vocab word to add to the speech box from the board </i> 
...
<i>Trigger: User deletes a vocab word from the speech box on the board </i>
...
<i> Trigger: Caregiver realizes they should include a word and clicks on the vocabulary management page. </i>
...
<i> Trigger: Caregiver clicks on a suggested word to add through the vocabulary management page. </i>
...
### Use Case 7 - Caregiver Removes Vocabulary Word 
<i> As a caregiver, I want to remove unused vocabulary words so that the user has a simple board. </i>

<i> Trigger: Caregiver realizes user doesn't use a vocab word and goes to remove it through the vocabulary management page. </i>
...
8. The system saves and removes the word to the database.
