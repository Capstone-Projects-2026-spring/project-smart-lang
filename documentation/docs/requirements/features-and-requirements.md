...
- Users will be able to create a user profile with Google OAuth SSO authentication.
  - Users are not required to have a registered account.
  - Accounts will save user data and can be accessed from different devices via Firestore cloud sync.
