...
| 2 | Selecting a word tile and constructing a sentence | User selects any word tile from the board with audio output | The word tile appears on the sentence bar and the word associated with the tile will be audibly played |
| 4 | Audio quality | User selects a word tile or play word to speech button | Audio is clear and played within 1 second of selecting a word tile or the word to speech button. |
| 5 |  |  |  |
| 6 |  |  |  |
| 7 |  |  |  |
| 8 |  |  |  |
