...
async function doActions(gridElement, gridId) {
    ...
    let displayUpdateActions = [GridActionSystem.getModelName()];
 ...
 * @param action
 * @param options
 * @param options.gridId the id of the grid the action is contained in (only needed for GridActionWebradio)
