...
constants.EMOJI_REGEX =
  /((\p{Regional_Indicator}{2})|((\p{Emoji}(?:\uFE0F|\u200D\p{Emoji})*)\u20E3?))/gu;
...
constants.EVENT_COLLECT_TEXT_CHANGED = "EVENT_COLLECT_TEXT_CHANGED";
...
constants.ENVIRONMENT = "#AAC_GRID_ENV#";
constants.IS_ENVIRONMENT_DEV = constants.ENVIRONMENT === "#AAC_" + "GRID_ENV#";
constants.IS_ENVIRONMENT_BETA = constants.ENVIRONMENT === "BETA";
constants.IS_ENVIRONMENT_PROD =
  !constants.IS_ENVIRONMENT_DEV && !constants.IS_ENVIRONMENT_BETA;
constants.FORCE_USE_SW = false;
constants.FORCE_CONNECT_DB = false;
constants.CURRENT_VERSION = "#AAC_GRID_VERSION#";
constants.IS_FIREFOX = navigator.userAgent.indexOf("Firefox") !== -1;
constants.IS_SAFARI = /^((?!chrome|android).)*safari/i.test(
  navigator.userAgent,
);
constants.IS_MAC = (
  navigator.platform ||
...
constants.BOARD_TYPES = [
  constants.BOARD_TYPE_SELFCONTAINED,
  constants.BOARD_TYPE_SINGLE,
];
...
constants.DEFAULT_ELEMENT_BACKGROUND_COLOR_DARK = "#ebebeb";
constants.DEFAULT_COLLECT_ELEMENT_BACKGROUND_COLOR = "#E8E8E8";
constants.DEFAULT_COLLECT_ELEMENT_BACKGROUND_COLOR_DARK = "#ffffff";
constants.DEFAULT_ELEMENT_BORDER_COLOR = "#c0c0c0";
...
constants.COLOR_SCHEME_FITZGERALD_VERY_LIGHT =
...
constants.CS_GOOSSENS_CATEGORIES = [
  constants.CC_VERB,
  constants.CC_DESCRIPTOR,
  constants.CC_PREPOSITION,
  constants.CC_NOUN,
  constants.CC_QUESTION_NEGATION_PRONOUN,
];
